...
class GCCritic(base_component.Component):
    def __init__(
        self,
        env_obs_shape: List[int],
        action_shape: List[int],
    ...
    def _make_qfunction(
        ...
        # print('input_dim: {}, hidden_dim: {}, output_dim: {}'.format(
        #     obs_dim, hidden_dim, action_shape[0]
        # ))
    ...
    def forward(
        ...
        # print('obs_action.shape: {}'.format(obs_action.shape))
        q1 = self.Q1(obs_action, adj) # NOTE: this change will work on with Graph-with-CARE config
